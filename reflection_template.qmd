...
#revised lab 4, changed the need for 2 tables and condensed into 1. 
plot_childcare <- ca_childcare |>
  pivot_longer( 
                cols = starts_with("mc_"),  
                names_to = "type", 
...
#revised code from lab 4: changed filter to use %in% and changed to arrange() function at the end. 
